...
<b>Note: I only havd to turn in a signature.txt file at the root of my repository. Which had the signature of my machine’s virtual disk.<br>
The monitoring.sh file, was only saved in this repo just so that I didn't had to remake the sript if the vm was lost, during the time that I was making the vm. (It was in a shool's pc)</b>
